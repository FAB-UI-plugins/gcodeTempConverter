...
foreach($_objects as $obj){
    ...
    $_edit_button    = '<a href="'.site_url('gcodeTempConverter/edit/'.$obj['id']).'" ><i class="fa fa-file fa-lg fa-fw txt-color-blue"></i> <u>E</u>dit</a>';
    ...
    $_link_edit      = '<a href="'.site_url('gcodeTempConverter/edit/'.$obj['id']).'">'.$obj['obj_name'].'</a>';
